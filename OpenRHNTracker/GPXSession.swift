...
//
//  Shared file: this file is also included in the OpenRHNTracker-Watch Extension target.
...
let kGPXCreatorString = "Open RHN Tracker for iOS"

#elseif os(watchOS)
/// GPX creator identifier. Used on generated files identify this app created them.
let kGPXCreatorString = "Open RHN Tracker for watchOS"
